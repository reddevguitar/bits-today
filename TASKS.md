...
## Now
- [x] Reduce automation cadence to a 6-hour major cycle
- [x] Deprioritize the old 30-minute BTC-centric loop
- [x] Maintain a refreshed Upbit alt preferred-buy top 5 list every cycle
- [x] Exclude Upbit scale top 4 majors from alt candidate picks automatically
- [x] Add icon-rich preferred-picks section to dashboard status
- [x] Show what changed and what improved this cycle in each report
- [x] Push paper portfolio toward diversified aggressive positioning logic
